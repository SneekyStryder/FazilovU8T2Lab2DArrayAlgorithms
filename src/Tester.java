...
public class Tester {
    ...
    //    System.out.println(Algorithm2DArrays.magicSquare(testArr7));
        ...
        String inputRow0 = scan.nextLine();
        String[] stringVals0 = inputRow0.split("\\ ");
        double[] row0 = new double[stringVals0.length];
        for (int i = 0; i < stringVals0.length; i++) {
            row0[i] = Double.parseDouble(stringVals0[i]);
        }
        System.out.print("Row 1: ");
        String inputRow1 = scan.nextLine();
        String[] stringVals1 = inputRow1.split("\\ ");
        double[] row1 = new double[stringVals1.length];
        for (int i = 0; i < stringVals1.length; i++) {
            row1[i] = Double.parseDouble(stringVals1[i]);
        }
        System.out.print("Row 2: ");
        String inputRow2 = scan.nextLine();
        String[] stringVals2 = inputRow2.split("\\ ");
        double[] row2 = new double[stringVals2.length];
        for (int i = 0; i < stringVals2.length; i++) {
            row2[i] = Double.parseDouble(stringVals2[i]);
        }

        double[][] fullList = {row0, row1, row2};

        System.out.println("Sum of the elements at Column 0: " + Algorithm2DArrays.sumColumn(fullList, 0));
        System.out.println("Sum of the elements at Column 1: " + Algorithm2DArrays.sumColumn(fullList, 1));
        System.out.println("Sum of the elements at Column 2: " + Algorithm2DArrays.sumColumn(fullList, 2));
        System.out.println("Sum of the elements at Column 3: " + Algorithm2DArrays.sumColumn(fullList, 3));
    }
}
